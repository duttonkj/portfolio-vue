<template>
  <div id="app" class="o-wrapper">
    ...
    <site-navigation>
      ...
      <div class="site-navigation__rail site-navigation__rail--right">
        <site-navigation-item link="/endorsements" color="purple">Endorsements</site-navigation-item>
        <site-navigation-item link="/recognition" color="purple">Recognition</site-navigation-item>
        <site-navigation-item link="/lets-talk" color="purple">Let's Talk</site-navigation-item>
      </div>
...
.o-wrapper {
 ...
 padding-right: var(--globalSpacingUnit);
 padding-left:  var(--globalSpacingUnit);
 margin-right: auto;
 margin-left:  auto;
 max-width: 1200px;
}
...
.o-layout {
  ...
  padding: 0; /* [2] */
  list-style: none; /* [1] */
  margin-left: -var(--globalSpacingUnit); /* [3] */
  font-size: 0;
}
...
.o-layout__item {
  ...
  width: 100%; /* [4] */
  padding-left: var(--globalSpacingUnit); /* [5] */
  font-size: 1rem;
